...
def get_header(payload: dict, name: str) -> str | None:
    ...
    return next((h["value"] for h in headers if h.get("name", "").lower() == name.lower()), None)
...
class EmailIngestionService:
    ...
    def __init__(self):
        ...
        self._pending_sync_times: dict[str, datetime] = {}
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        res = await ingestion.fetch_all_user_emails()
